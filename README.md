...
[![x-cmd/install — mcp-cli Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/mcp-cli.svg)](https://x-cmd.com/install/mcp-cli)
...
Total: **4,552** lines of code across **30** files in the top 5 languages.
...
- **Stars**: 1,276 · **Forks**: 165 · **Open issues**: 20 · **Contributors**: 2

## Totals (cumulative)

- **Releases**: 5 · **Merged PRs**: 4 · **Open PRs**: 220 · **Closed issues**: 5 · **Open issues**: 15 · **Commits**: 30
...
_Snapshot: `data/card/260924.yml` · 2026-09-24T05:09:29Z._
