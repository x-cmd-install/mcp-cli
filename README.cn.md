...
[![x-cmd/install — mcp-cli Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/mcp-cli.svg?lang=zh)](https://x-cmd.com/install/mcp-cli)
...
- **Star**: 1,276 · **Fork**: 165 · **开放 issue**: 20 · **贡献者**: 2

## 累计统计

- **发布数**: 5 · **已合并 PR**: 4 · **开放 PR**: 220 · **已关闭 issue**: 5 · **开放 issue**: 15 · **提交数**: 30
...
| last180d | 2026-03-28 | 0 | 0 | 36 | 0 | 2 | 0 |
| 360d | 2025-09-29 | 5 | 4 | 220 | 5 | 15 | 27 |
| last720d | 2024-10-04 | 5 | 4 | 220 | 5 | 15 | 30 |
...
mcp-cli 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `mcp-cli` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/mcp-cli.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T05:09:30Z._
